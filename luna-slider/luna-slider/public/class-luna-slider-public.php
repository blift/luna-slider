...
class Luna_Slider_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/luna-slider-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'owl-my-script', plugin_dir_url( __FILE__ ) . 'js/luna-slider-public.js', array( 'jquery' ), $this->version, false );
